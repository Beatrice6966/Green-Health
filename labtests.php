...
$sql = "INSERT INTO labtests (address, date, time, minutes, tests, user_id) VALUES ('$address', '$date', '$time', $minutes, '$tests', '$user_id')";
...
<body>
<div class="p-3 mb-2 bg-primary text-white"><center> thank you! Please Pay the Amount using LIPA number<b> 35196645</b></center></div>
